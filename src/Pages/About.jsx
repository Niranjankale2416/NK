...
const Header = memo(() => (
  <div className="text-center mb-8 px-6 sm:px-12">
    <h2
      className="text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-500 to-purple-500"
      data-aos="zoom-in-up"
    ...
    <p
      className="mt-2 text-gray-300 text-lg sm:text-xl flex items-center justify-center gap-2"
      data-aos="zoom-in-up"
      data-aos-duration="800"
    >
      <Sparkles className="w-5 h-5 text-purple-400" />
      Creating digital experiences with innovation
      <Sparkles className="w-5 h-5 text-purple-400" />
    </p>
  </div>
));
...
const AboutPage = () => {
  ...
  const { totalProjects, totalCertificates, YearExperience } = useMemo(() => {
    ...
    return {
      totalProjects: getData("projects").length,
      totalCertificates: getData("certificates").length,
      YearExperience: new Date().getFullYear() - 2021,
    };
  }, []);
    ...
    <div className="text-white px-6 sm:px-12 mt-10" id="About">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
        ...
        <div className="text-center lg:text-left">
          ...
          >
            Passionate IT professional with expertise in Java, C#, Python, JavaScript, SQL, Active Directory,
            and ServiceNow. I thrive in designing, troubleshooting, and optimizing IT solutions while exploring
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 mt-6">
            <a
              href="https://drive.google.com/file/d/1AGT3odtAkhl8Gs0smykMD09rXBJptYhE/view?usp=drive_link"
