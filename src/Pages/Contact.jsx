    ...
    <>
      ...
      >
        <div
          ...
          className="w-full max-w-2xl bg-white/5 backdrop-blur-xl rounded-3xl shadow-2xl p-5 py-10 sm:p-10"
        >
          ...
          <form
            action="https://formsubmit.co/cm.niranjank@gmail.com"
            method="POST"
          ...
          >
            ...
            <div className="relative group">
              ...
              <textarea
                ...
                onChange={handleChange}
                disabled={isSubmitting}
                className="w-full p-4 pl-12 bg-white/10 rounded-xl border border-white/20 placeholder-gray-500 text-white h-[9.9rem]"
                required
              />
            </div>
